    ...
    <div className="about-project">
      ...
      <div className="about-project__scheme">
        <div className="about-project__container about-project__container_backend">
          <p className="about-project__scale about-project__scale_green">
            1 неделя
          </p>
          <p className="about-project__scale about-project__scale_task">
            Back-end
          </p>
        </div>
        <div className="about-project__container about-project__container_frontend">
          <p className="about-project__scale about-project__scale_grey">
            4 недели
          </p>
          <p className="about-project__scale about-project__scale_task">
            Front-end
